...
.scrollingtable {
  ...
  height: 482px/*100%*/; /*set table height here; can be fixed value or %*/
  ...
  <div>
    <div>
      <table>
        <thead>
          <tr>
            <th><div label="POJEMNIK"></div></th>
            <th><div label="ILOSC"></div></th>
            <th><div label="PODWOZIA"></div></th>
			<th><div label="PRIOR."></div></th>
			<th><div label="SR"></div></th>
			<th><div label="SR"></div></th>
			<th><div label="CR"></div></th>
			<th><div label="ID PRAC."></div></th>
		...
		for ($i=0; $i < $ile_znalezionych; $i++)
        {
				...
				$interval = $czas->format('%H');
				$interval1 = $czas->format('%I');
				$interval2 = $czas->format('%S');
				...
				echo '<tr>
							...
							<td>' . $interval . ':' .$interval1 . ':' . $interval2 . '</td>
